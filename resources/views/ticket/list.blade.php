        ...
        <table class="table table-striped">
            ...
            @foreach($tickets as $ticket)
                <tr>
                    ...
                    <td class="text-center">@if($ticket->priority == 1) up @elseif($ticket->priority == 2) middle @else down @endif</td>
                    ...
                    <td class="text-center"><a href="{{route('message.show')}}" onclick="showMessage(this);return false;" class="btn btn-info btn-sm">
                            <i class="fa fa-eye">show</i>
                        </a>
                    </td>
                    <td class="text-center">
                        <a href="{{route('ticket.show', ['ticket' => $ticket])}}" class="btn btn-warning btn-sm">Edit</a>
                        <a href="{{route('ticket.delete', ['ticket' => $ticket])}}" class="btn btn-danger btn-sm">Delete</a>
                    </td>
                </tr>
            @endforeach
        </table>
